...
def v2SAPSolutionsArchitect(previous_solution, critique, solutions_architect_task):
    ...
    def scrape_website(objective: str, url: str):
        ...
        print("Scraping website to refine Solutions Architect solutions...")
    ...
    system_message = SystemMessage(
        content=f"""You are a world class SAP Solutions Architect researcher with a deep expertise in the field of crafting solutions in SAP environments,
